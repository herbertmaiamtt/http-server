...
public class WebRootHandlerTest {
    ...
    @BeforeAll
    public void beforeClass() throws NoSuchMethodException, WebRootNotFoundException {
    ...
    void constructorGoodPath() {
        try {
            WebRootHandler webRootHandler = new WebRootHandler("\\home\\herbertmtmt\\IdeaProjects\\httpserver\\WebRoot");
